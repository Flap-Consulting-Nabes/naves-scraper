...
# ---------------------------------------------------------------------------
# Tipo de operación (venta/alquiler) — implementation lives in parser_ad_type
# ---------------------------------------------------------------------------
# Codex review R1: the 4-layer cascade and its keyword tables were extracted
# into integrations/parser_ad_type.py (~150 lines). Re-exported here so
# external imports (`from integrations.parser import parse_ad_type`) keep
# working unchanged.
from integrations.parser_ad_type import (  # noqa: E402
